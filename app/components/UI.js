...
function UI() {
  return (
    <div className="bg-transparent fixed top-100 md:top-120 left-0  w-full  flex   justify-center items-center">
   <div className="ui flex  text-white bg-neutral-700 opacity-90 rounded-2xl px-2 py-2 shadow-lg shadow-neutral-900/50 backdrop-blur-md ">
